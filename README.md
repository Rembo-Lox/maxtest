...
Небольшой сервис на FastAPI. Что он делает:
...
2. Входящий вебхук - чтобы сервер сам мог читать/писать в сделку через REST API
...
Нужен серверу чтобы читать/писать сделки.
